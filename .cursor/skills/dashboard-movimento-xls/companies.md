...
| `jpg` | JPG - PRODUTOS FUNCIONAIS | ver filiais | `src/views/jpg.ejs` | `JPG_DATA.fiscalPorMes.porMes["YYYY-MM"].filiais[key]` — PR=`21051983000670` (81), MG=`…/0005-99` (90), SP=`…/0007-50` (82), MATRIZ DF=`…/0003-27` (712), SEDE/Matriz Sede=`…/0001-65` (711). Não confiar no nome da pasta (`ind`=Matriz DF; `matriz e filial`=SEDE). |
