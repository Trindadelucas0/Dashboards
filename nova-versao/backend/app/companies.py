...
COMPANIES: tuple[CompanyReg, ...] = (
    ...
    CompanyReg(
        id="loja-maquinas",
        label="Loja das Máquinas",
        cnpj="13983066000190",
        name_re=r"LOJA\s*DAS\s*MAQUINAS|LOJA\s*M[AÁ]QUINAS",
        username="loja-maquinas",
        theme="green",
        units=(Unit("matriz", "Matriz", "13983066000190", r"LOJA"),),
    ),
    CompanyReg(
        id="unica",
        label="Única",
        cnpj="36517206000130",
        name_re=r"\b[UÚ]NICA\b",
        username="unica",
        theme="blue",
